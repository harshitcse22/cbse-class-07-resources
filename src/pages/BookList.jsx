...
const subjectColorClass = {
  ...
  arts:                                'text-rose-500',
  'vocational-education':              'text-amber-500',
}
...
export default function BookList() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title={`Class 7 ${fmt(subject)} – ${fmt(book)}`}
        description={`Browse all ${fmt(book)} chapters for CBSE Class 7 ${fmt(subject)}. Access free AI prompts for every chapter to use with ChatGPT, Gemini, or Claude.`}
      />
      <Navbar />
