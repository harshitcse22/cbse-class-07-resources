...
const subjectConfig = {
  mathematics:                          { Icon: Calculator,   desc: 'Integers, Fractions, Algebra, Geometry, Data Handling and more.' },
  science:                              { Icon: FlaskConical, desc: 'Nutrition, Heat, Acids & Bases, Weather, Motion and more.' },
  english:                              { Icon: Languages,    desc: 'Honeycomb, An Alien Hand — prose, poetry, and supplementary readers.' },
  'social-science':                     { Icon: Landmark,     desc: 'History, Geography, Political Science chapters.' },
  hindi:                                { Icon: BookMarked,   desc: 'Vasant, Durva, Mahabharat — all Hindi books.' },
  sanskrit:                             { Icon: Scroll,       desc: 'Ruchira — Sanskrit textbook for Class 7.' },
  ...
  'vocational-education':               { Icon: GraduationCap, desc: 'Kaushal Bodh — vocational skills and life skills.' },
}
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title="CBSE Class 7 AI Study Prompts"
        description="Free chapter-wise AI prompts for CBSE Class 7 across all subjects. Use with ChatGPT, Gemini, or Claude to study smarter and score better."
      />
      <Navbar />
          ...
          <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 items-start">
            ...
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-3">
                CBSE Class 7<br />Most Effective<br/>
                <span className="text-4xl lg:text-5xl font-bold text-blue-600 leading-tight tracking-tight">
                  Prompts
                </span>
              </h1>
              <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-md">
                Free chapter-wise NCERT prompts, structured by subject, book, and chapter for CBSE Class 7 students
              </p>
