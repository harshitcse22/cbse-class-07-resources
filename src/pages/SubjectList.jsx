...
const subjectMeta = {
  ...
  'vocational-education':              { Icon: GraduationCap, colorClass: 'text-amber-500',  bgClass: 'bg-amber-50'  },
}
...
export default function SubjectList() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <SEO
        title={`Class 7 ${fmt(subject)} Prompts`}
        description={`Explore all ${fmt(subject)} books and chapters for CBSE Class 7. Access free AI prompts for every chapter to use with ChatGPT, Gemini, and Claude.`}
      />
      <Navbar />
      <main className="flex-1">
        <div className="bg-white border-b border-gray-100 px-6 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">CBSE Class 7 {fmt(subject)}</h1>
